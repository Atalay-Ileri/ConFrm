Require Export Disk.Definitions.
(*
...
Notation "'DiskLayer.exec'" := DiskLayer.Definitions.exec.
Notation "'DiskLayer.token_dec'" := DiskLayer.Definitions.token_dec.
Notation "'DiskLayer.Ret'" := DiskLayer.Definitions.Ret.
Notation "'DiskLayer.Bind'" := DiskLayer.Definitions.Bind.
