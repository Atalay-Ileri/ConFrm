...
Require Import FunctionalExtensionality Lia SameRetType. (*TSCommon*)
...
Lemma recovery_oracles_refine_same:
...
p2 get_reboot_state  o_imp o_abs' ->
    ...
    refines s2_imp x0 ->
same_for_user_except u' ex x x0 ->
recovery_oracles_refine FDRefinement u s1_imp p1 
    (| Recover |) [] l_o_imp l_o_abs ->
recovery_oracles_refine FDRefinement u s2_imp p2
    (| Recover |) [] l_o_imp l_o_abs' ->
l_o_abs = l_o_abs'.
Proof.
...
recovery_oracles_refine FDRefinement u s1_imp 
  (| Recover |) (| Recover |) (authenticated_disk_reboot_list n) l_o_imp
  l_o_abs ->
recovery_oracles_refine FDRefinement u s2_imp 
  (| Recover |) (| Recover |) (authenticated_disk_reboot_list n) l_o_imp
...
Proof.
    ...
    refines_related; intros; destruct n; simpl in *; cleanup.
     {
        eapply recovery_oracles_refine_same; [| | | eauto | |]; eauto.
        intros.
