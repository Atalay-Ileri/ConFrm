...
| [H: LayerImplementation.exec' _ _ _ (Bind _ _) _,
H0: LayerImplementation.exec' _ _ _ (Bind _ _) _ |- _] =>
invert_exec'' H; invert_exec'' H0
end.
...
| [ H: LayerImplementation.exec' _ _ _ ?p _ |- _ ] =>
    match p with
    | Bind _ _ => fail
    | Op _ _ => invert_exec'' H
    | Ret _ => invert_exec'' H
...
| [ H: LayerImplementation.exec' _ _ _ (lift_L1 _ _) (Finished _ _) |- _ ] =>
    eapply Automation.lift1_invert_exec in H; logic_clean
| [ H: LayerImplementation.exec' _ _ _ (lift_L2 _ _) (Finished _ _) |- _ ] =>
    eapply Automation.lift2_invert_exec in H; logic_clean
| [ H: LayerImplementation.exec' _ _ _ (lift_L1 _ _) (Crashed _) |- _ ] =>
    eapply Automation.lift1_invert_exec_crashed in H; logic_clean
| [ H: LayerImplementation.exec' _ _ _ (lift_L2 _ _) (Crashed _) |- _ ] =>
    eapply Automation.lift2_invert_exec_crashed in H; logic_clean
| [H: LayerImplementation.exec' _ _ _ (Op _ (P1 _)) _ |- _ ]=>
    invert_exec'' H
| [H: LayerImplementation.exec' _ _ _ (Op _ (P2 _)) _ |- _ ]=>
    invert_exec'' H
