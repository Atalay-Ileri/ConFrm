...
Lemma layer1_exec_finished_deterministic:
...
Lemma layer1_finished_not_crashed_oracle_app:
...
Proof.
  ...
  -
    ...
    eapply layer1_exec_finished_deterministic in H0; eauto; cleanup; eauto.
    apply app_inv_head in H4; cleanup; eauto.
Qed.

Lemma layer1_exec_deterministic:
...
Proof.
  ...
  -
    split_ors; cleanup.
    exfalso; clear H2; eapply layer1_finished_not_crashed_oracle_app; eauto.
...
Qed.
  ...
  Proof.
    ...
    do 2 eexists; intuition eauto.
    eapply layer1_exec_deterministic in H0; eauto; cleanup; eauto.
    eapply layer1_exec_deterministic in H0; eauto; cleanup.
  Qed.
(*
